package com.vivekchutke.webfluxstockquoteservice;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)  // ** Check how a Random port is assiged for INTEGRATION testing
public class WebfluxStockQuoteServiceApplicationTest {

//    @Autowired     //spring will inject a configured webTestClient
    private WebTestClient webTestClient;

    public WebfluxStockQuoteServiceApplicationTest(WebTestClient webTestClient) {
