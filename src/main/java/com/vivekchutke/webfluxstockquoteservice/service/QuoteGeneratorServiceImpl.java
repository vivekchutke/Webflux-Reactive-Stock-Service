...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public QuoteGeneratorServiceImpl() {
        this.prices.add(new Quote("APPL", 399.99));
        this.prices.add(new Quote("AA", 15.65));
        this.prices.add(new Quote("GE", 11.88));
        this.prices.add(new Quote("TSLA", 899.99));
        this.prices.add(new Quote("GOOG", 1452.23));
        this.prices.add(new Quote("M", 15.25));
        this.prices.add(new Quote("WAB", 76.23));
        this.prices.add(new Quote("SLV", 15.26));
        this.prices.add(new Quote("CSCO", 46.23));
    ...
    public Flux<Quote> fetchQuoteStream(Duration period) {
        ...
        return Flux.generate(() -> 0,
                ...
                .log("com.vivekchutke.webfluxstockquoteservice.service.QuoteGenerator");
    }
